...
analyze_name_ablation_list.append('_scalar_weight')
analyze_name_ablation_list.append('_scalar_weight_endtoend')
analyze_name_ablation_list.append('_scalar_weight_endtoend_fix')
analyze_name_ablation_list.append('_mid')

# define model name
model_name_list = []
model_name_list.append('simple_average')
model_name_list.append('weight')
model_name_list.append('weight_endtoend')
model_name_list.append('weight_endtoend_fix')
model_name_list.append('mid')
...
for test_data_type in test_data_type_list:
    ...
    for analyze_name in analyze_name_list:
        ...
        save_csv_file_path = os.path.join(saved_result_dir, f'p_s_gen_ablation_volleyball_{test_data_type}.csv')
