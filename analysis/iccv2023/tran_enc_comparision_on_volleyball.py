...
analyze_name_ablation_list.append('_enc_1')
analyze_name_ablation_list.append('')
analyze_name_ablation_list.append('_enc_3')
analyze_name_ablation_list.append('_enc_4')

# define model name
model_name_list = []
model_name_list.append('1')
model_name_list.append('2')
model_name_list.append('3')
...
for test_data_type in test_data_type_list:
    ...
    for analyze_name in analyze_name_list:
        ...
        save_csv_file_path = os.path.join(saved_result_dir, f'trans_enc_{analyze_name}_{test_data_type}.csv')
