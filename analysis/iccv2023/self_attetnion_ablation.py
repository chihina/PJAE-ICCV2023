...
analyze_name_ablation_list.append('_ind_only_wo_trans')
analyze_name_ablation_list.append('_token_only_wo_trans')
analyze_name_ablation_list.append('_token_only')

# define model name
model_name_list = []
model_name_list.append('ind_wo_trans')
model_name_list.append('token_wo_trans')
...
for test_data_type in test_data_type_list:
    ...
    for analyze_name in analyze_name_list:
        ...
        save_csv_file_path = os.path.join(saved_result_dir, f'self_attention_ablation_{analyze_name}_{test_data_type}.csv')
