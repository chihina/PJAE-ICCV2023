...
analyze_name_list = []
analyze_name_list.append('videocoatt-p_p_field_deep_p_s_davt')
...
analyze_name_ablation_list.append('freeze')
...
for test_data_type in test_data_type_list:
    ...
    for analyze_name in analyze_name_list:
        ...
        save_csv_file_path = os.path.join(saved_result_dir, f'p_s_gen_ablation_videocoatt_{test_data_type}.csv')
