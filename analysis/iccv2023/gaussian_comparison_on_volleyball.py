...
analyze_name_ablation_list.append('_var_100')
analyze_name_ablation_list.append('_var_80')
analyze_name_ablation_list.append('_var_60')
analyze_name_ablation_list.append('_var_40')
analyze_name_ablation_list.append('_var_20')
analyze_name_ablation_list.append('')
analyze_name_ablation_list.append('_var_5')
analyze_name_ablation_list.append('_var_1')

# define model name
model_name_list = []
model_name_list.append('100')
model_name_list.append('80')
model_name_list.append('60')
model_name_list.append('40')
model_name_list.append('20')
model_name_list.append('10')
model_name_list.append('5')
...
for test_data_type in test_data_type_list:
    ...
    for analyze_name in analyze_name_list:
        ...
        save_csv_file_path = os.path.join(saved_result_dir, f'gaussian_comparison_{analyze_name}_{test_data_type}.csv')
