...
class JointAttentionEstimatorTransformerDualImgFeat(nn.Module):
    def __init__(self, cfg):
        super(JointAttentionEstimatorTransformerDualImgFeat, self).__init__()
    ...
    def forward(self, inp):
        ...
        person_scene_attention_heatmap = person_scene_attention_heatmap.view(self.batch_size*self.frame_num*self.people_num, 1, self.hm_height_middle_p_s, self.hm_width_middle_p_s)
        ...
        person_scene_joint_attention_heatmap = torch.sum(person_scene_attention_heatmap, dim=2)
        no_pad_idx_cnt = torch.sum((torch.sum(head_feature, dim=-1) != 0), dim=2)
    ...
    def calc_loss(self, inp, out, cfg):
        ...
        person_person_attention_heatmap = person_person_attention_heatmap.view(self.batch_size*self.frame_num*self.people_num, 1, self.hm_height, self.hm_width)
        ...
        person_person_attention_heatmap = person_person_attention_heatmap.view(self.batch_size, self.frame_num, self.people_num, self.resize_height, self.resize_width)
        ...
        person_person_joint_attention_heatmap = person_person_joint_attention_heatmap.view(self.batch_size, self.frame_num, 1, self.resize_height, self.resize_width)
        ...
        person_scene_attention_heatmap = person_scene_attention_heatmap.view(self.batch_size*self.frame_num*self.people_num, 1, self.hm_height_p_s, self.hm_width_p_s)
        ...
        person_scene_joint_attention_heatmap = person_scene_joint_attention_heatmap.view(self.batch_size*self.frame_num, 1, self.hm_height_p_s, self.hm_width_p_s)
        ...
        person_scene_joint_attention_heatmap = person_scene_joint_attention_heatmap.view(self.batch_size, self.frame_num, 1, self.resize_height, self.resize_width)
