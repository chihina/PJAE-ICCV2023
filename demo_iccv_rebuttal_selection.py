...
model_name_dic = {}
# model_name_dic['volleyball-dual-mid_p_p_field_middle_bbox_GT_gaze_GT_act_GT'] = 'final_joint_attention_heatmap'

# model_name_dic['videocoatt-dual-people_field_middle_token_only_bbox_GT_gaze_GT'] = 'final_joint_attention_heatmap'
model_name_dic['videocoatt-p_p_field_deep_p_s_davt_scalar_weight_fix_token_only_GT'] = 'final_joint_attention_heatmap'
...
save_csv_file_path = os.path.join(save_results_dir, f'iccv_rebuttal_selection.csv')
